...
\textit{tagsnip} is a \LaTeX{} package for including tagged code snippets from local files or remote URLs. 
...
\textit{tagsnip} consists of two main parts: a \LaTeX{} frontend package and an external backend utility written in Python. 
...
\begin{itemize}
    \item \textit{tagsnip} requires the Lua\LaTeX{} compiler.
